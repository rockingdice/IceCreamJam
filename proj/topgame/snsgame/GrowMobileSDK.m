...
static NSString *GrowMobileSDK_APP_KEY = nil;
static NSString *GrowMobileSDK_APP_SECRET = nil;
...
{
    GrowMobileSDK_APP_KEY = [key retain];
    GrowMobileSDK_APP_SECRET = [secret retain];
}
...
+ (NSString *) generateSignature:(NSString *)udid
{
    NSString *signature =
        [NSString stringWithFormat:@"%@:%@:%@",
            GrowMobileSDK_APP_KEY, udid, GrowMobileSDK_APP_SECRET];
...
+ (NSMutableString *) getBaseUrl:(NSString *)action
{
    ...
    NSMutableString *baseUrl = [NSMutableString stringWithFormat:
        ...
        GROW_MOBILE_API_URL, action, GrowMobileSDK_APP_KEY, udid, udid_md5, udid_sha1, mac, mac_md5, mac_sha1];
