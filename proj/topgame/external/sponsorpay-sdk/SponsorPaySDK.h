...
/** @name Using the Mobile Interstitial */
...
/**
 ...
 @return An instance of SPInterstitialViewController configured with the appId and userId provided previously to the SDK start method.
 
 @see startLoadingInterstitialWithParentViewController:
...
/**
 ...
 @param credentialsToken The credentials string token returned by a previous invocation of startForAppId:userId:securityToken: whose appId and userId will be configured in the returned SPInterstitialViewController instance. If you pass an invalid credentials token, this method will throw an exception.
 
 @return An instance of SPInterstitialViewController configured with the appId and userId corresponding to the provided credentials token.
 */
...
/**
 ...
 @param parent An instance of your own UIViewController subclass that will be used as the parent view controller of the presented OfferWall. It must conform to the SPInterstitialViewControllerDelegate protocol, and will be notified whenever the Interstitial is closed.
 
 @return The instance of SPInterstitialViewController which is being presented.
