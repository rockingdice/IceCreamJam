...
// Undefine the following constant to let the SDK use iOS 5+ built-in JSON parser instead of the SBJson library
#define kSPUseSBJsonParser

#ifdef kSPUseSBJsonParser
FOUNDATION_EXPORT NSString *const SPSBJsonParsingErrorDomain;
#endif
...
- (id)initWithUserId:(NSString *)userId
         ...
         secretToken:(NSString *)secretToken __deprecated;
