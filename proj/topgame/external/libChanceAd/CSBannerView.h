 ...
 */
- (void)loadRequest:(CSADRequest *)pbRequest;
...
// 收到Banner广告
- (void)pbBannerViewDidReceiveAd:(CSBannerView *)pbBannerView;

// Banner广告数据错误
- (void)pbBannerView:(CSBannerView *)pbBannerView
      receiveAdError:(CSRequestError *)requestError;

// 将要展示Banner广告
- (void)pbBannerViewWillPresentScreen:(CSBannerView *)pbBannerView;

// 移除Banner广告
- (void)pbBannerViewDidDismissScreen:(CSBannerView *)pbBannerView;
