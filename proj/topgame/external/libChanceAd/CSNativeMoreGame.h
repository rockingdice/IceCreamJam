...
- (void)pbNativeMoreGameDidPresentScreen:(CSNativeMoreGame *)pbNativeMoreGame;

// 原生精品推荐将要关闭
- (void)pbNativeMoreGameWillDismissScreen:(CSNativeMoreGame *)pbNativeMoreGame;

// 原生精品推荐关闭完成（只对IOS5以上的present方式有效）
- (void)pbNativeMoreGameDidDismissScreen:(CSNativeMoreGame *)pbNativeMoreGame;
