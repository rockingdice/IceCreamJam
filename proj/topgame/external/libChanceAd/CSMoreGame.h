 ...
 */
- (void)loadMoreGame:(CSADRequest *)pbRequest;
...
// 精品推荐加载完成
- (void)pbMoreGameDidLoadAd:(CSMoreGame *)pbMoreGame;

// 精品推荐加载错误
- (void)pbMoreGame:(CSMoreGame *)pbMoreGame
loadAdFailureWithError:(CSRequestError *)requestError;

// 精品推荐打开完成
- (void)pbMoreGameDidPresentScreen:(CSMoreGame *)pbMoreGame;

// 精品推荐将要关闭
- (void)pbMoreGameWillDismissScreen:(CSMoreGame *)pbMoreGame;

// 精品推荐关闭完成
- (void)pbMoreGameDidDismissScreen:(CSMoreGame *)pbMoreGame;
