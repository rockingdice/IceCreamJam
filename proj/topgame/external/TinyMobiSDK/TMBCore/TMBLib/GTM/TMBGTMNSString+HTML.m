...
@implementation NSString (TMBGTMNSStringHTMLAdditions)

- (NSString *)tmb_gtm_stringByEscapingHTMLUsingTable:(HTMLEscapeMap*)table 
  ...
  if (!buffer) {
    ...
    if (!data) {
      ...
      _TMBGTMDevLog(@"couldn't alloc buffer");
      return nil;
      // COV_NF_END
    }
  ...
  if (!buffer || !data2) {
    // COV_NF_START
    _TMBGTMDevLog(@"Unable to allocate buffer or data2");
    return nil;
    // COV_NF_END
  }
  ...
  for (NSUInteger i = 0; i < length; ++i) {
    ...
    if (val || (escapeUnicode && buffer[i] > 127)) {
      ...
      if (val) {
        ...
        _TMBGTMDevAssert(escapeUnicode && buffer[i] > 127, @"Illegal Character");
...
- (NSString *)tmb_gtm_stringByEscapingForHTML {
  return [self tmb_gtm_stringByEscapingHTMLUsingTable:gUnicodeHTMLEscapeMap 
                                           ofSize:sizeof(gUnicodeHTMLEscapeMap) 
                                  escapingUnicode:NO];
} // gtm_stringByEscapingHTML

- (NSString *)tmb_gtm_stringByEscapingForAsciiHTML {
  return [self tmb_gtm_stringByEscapingHTMLUsingTable:gAsciiHTMLEscapeMap 
                                           ofSize:sizeof(gAsciiHTMLEscapeMap) 
                                  escapingUnicode:YES];
} // gtm_stringByEscapingAsciiHTML

- (NSString *)tmb_gtm_stringByUnescapingFromHTML {
