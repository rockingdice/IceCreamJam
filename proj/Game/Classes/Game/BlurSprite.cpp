...
SpriteBlur* SpriteBlur::createWithSpriteFrame(cocos2d::CCSpriteFrame *frame)
{
    SpriteBlur * pRet = new SpriteBlur;
...
void SpriteBlur::initProgram()
{
    GLchar * fragSource = (GLchar*) CCString::createWithContentsOfFile(
                                                                       CCFileUtils::sharedFileUtils()->fullPathForFilename("shader/example_Blur.fsh").c_str())->getCString();
